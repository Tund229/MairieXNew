                            ...
                            <table class="table" id="dataTable">
                                <thead>
                                    <tr class="text-nowrap">
                                        <th class="text-center">Numéro de l'acte</th>
                                        <th class="text-center">Année de divorce</th>
                                ...
                                <tbody>
                                    @foreach ($guichetDivorces as $guichetDivorce)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{route('agent.guichet-divorce.show', $guichetDivorce->id)}}" class="btn btn-primary">Détails</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
