                        ...
                        <form class="md-float-material" action="{{ route('login') }}" method="POST">
                            ...
                            <div class="auth-box">
                                ...
                                <div class="row m-b-20">
                                    <div class="col-md-12">
                                        <h3 class="text-left text-center">Connexion</h3>
                                    </div>
                                </div>
                                <hr />
                                ...
                                <div class="row m-t-25 text-left">
                                    <div class="col-sm-6 col-xs-12 forgot-phone ">
                                        <a href="{{route('restore_account_view')}}" class="text-right f-w-600  text-primary">Mot de passe
                                            oublié?</a>
                                    </div>
                                </div>
                                <div class="row m-t-30">
                                    <div class="col-md-12">
                                        <button type="submit"
                                            class="btn btn-primary btn-md btn-block  text-center m-b-20">Connexion</button>
                                    </div>
                                </div>
                                <hr />
                                <div class="row">
